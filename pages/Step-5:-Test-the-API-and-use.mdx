...
1. Take the API which is Generated From API Gateway Service amd paste it into Postman and change The Http Request Methond into **PUT**
2. On Request Body, Choose Binary and Upload any image for test the api then click Send Button
...
This is also a Cloudfront Service Security Purpose**